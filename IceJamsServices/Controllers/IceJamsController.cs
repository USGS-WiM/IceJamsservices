...
{
    [Route("[controller]")]
    public class IceJamsController : WiM.Services.Controllers.ControllerBase
    {
        public IIceJamsAgent agent { get; set; }
        public IceJamsController(IIceJamsAgent agent ) : base()
        {
            this.agent = agent;
        }
        #region METHODS
